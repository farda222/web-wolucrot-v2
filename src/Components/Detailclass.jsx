...
const Detail = () => {
  ...
  return (
    <>
      ...
      <div className="flex justify-center align-middle items-center mx-auto container gap-6 mt-7 ml-1">
        ...
        <div className="relative flex-row -ml-4">
          <button onClick={() => setIsOpen(!isOpen)} className="flex items-center justify-center w-8 h-8 bg-white rounded-full focus:outline-none focus:bg-gray-300">
      ...
      <div className="flex gap-6 mt-10 bg-neutral-200 p-3">
